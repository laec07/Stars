...
const Default = {
    ...
    setColorEvent   : function(event) {return null},
...
const EventParams = {
    ...
    height    : Math.min(20,Default.rowHeight - Default.marginHeight * 2),
    start     : '',
    end       : '',
    row       : 1,
    bgColor   : '#E7E7E7',
...
//console.log( _item_width, _ruler_string, _ruler_string.length, this.strWidth( _ruler_string ), $(this._element).width() )
                if ( _item_width > $(this._element).width() ||  line_scale=="hour") {
...
//console.log( '!showLoader:', width, height, _container.length )
        ...
        if ( $(_opts.loader).length == 0 ) {
            let _loading_text = this._config.loadingMessage.match(/[\uD800-\uDBFF][\uDC00-\uDFFF]|[\s\S]|^$/g).filter( Boolean )

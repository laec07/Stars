(function ($) {
    ...
    $(document).on('click', '.dTableView', function () {
        ...
        var htmlPrint = `
            <html>
            <head>
                <title>Imprimir Evaluación de Sensibilidad Healing Hands</title>
                <style>
                    body {
                        display: flex;
    ...
    var Manager = {
        ...
        Save: function (form) {
            if (Message.Prompt()) {
                ...
                var serviceUrl = "sensitivitys-create";
        ...
        Update: function (form, id) {
            if (Message.Prompt()) {
                ...
                JsManager.StartProcessBar();
                var jsonParam = form.serialize();
                var serviceUrl = "sensitivitys-update";
                JsManager.SendJson("POST", serviceUrl, jsonParam, onSuccess, onFailed);
        ...
        Delete: function (id) {
            if (Message.Prompt()) {
                JsManager.StartProcessBar();
                var jsonParam = { id: id };
                var serviceUrl = "sensitivitys-delete";
                JsManager.SendJson("POST", serviceUrl, jsonParam, onSuccess, onFailed);
        ...
        GetDataList: function (refresh) {
            var jsonParam = '';
            var serviceUrl = "get-sensitivitys"; // cambiar
                    ...
                    buttons: [
                        {
                            ...
                            title: 'Sensitivity evaluation List' // cambiar
                        },
                        {

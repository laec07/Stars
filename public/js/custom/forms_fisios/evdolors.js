(function ($) {
    ...
    $(document).on('click', '.dTableView', function () {
        ...
        var htmlPrint = `
            <html>
            <head>
    <title>Imprimir Evaluación Del Dolor</title>
    <style>
        body {
        ...
        span {
            ...
            <body>
            <h2>Evaluación Del Dolor Healing Hands</h2>
    ...
    var Manager = {
        ...
        Save: function (form) {
            if (Message.Prompt()) {
                ...
                var serviceUrl = "evdolors-create";
        ...
        Update: function (form, id) {
            if (Message.Prompt()) {
                ...
                JsManager.StartProcessBar();
                var jsonParam = form.serialize();
                var serviceUrl = "evdolors-update";
                JsManager.SendJson("POST", serviceUrl, jsonParam, onSuccess, onFailed);
        ...
        Delete: function (id) {
            if (Message.Prompt()) {
                JsManager.StartProcessBar();
                var jsonParam = { id: id };
                var serviceUrl = "evdolors-delete";
                JsManager.SendJson("POST", serviceUrl, jsonParam, onSuccess, onFailed);
        ...
        GetDataList: function (refresh) {
            var jsonParam = '';
            var serviceUrl = "get-evdolors"; // cambiar
                    ...
                    buttons: [
                        {
                            ...
                            title: 'Pain assessment List' // cambiar
                        },
                        {
